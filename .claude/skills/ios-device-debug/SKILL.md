...
1. **Xcode 27 is running with the project open.** The bridge only enumerates
   ...
   `open -a "/Applications/Xcode-27.0.0-Beta.2.app" iosApp/iosApp.xcodeproj`
...
```bash
export DEVELOPER_DIR=/Applications/Xcode-27.0.0-Beta.2.app/Contents/Developer  # adjust
UUID=<sim-uuid>

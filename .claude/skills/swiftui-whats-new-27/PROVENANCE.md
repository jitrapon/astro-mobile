# Provenance & vetting — `swiftui-whats-new-27`
...
- **Portability:** Pure knowledge skill (Apple SwiftUI guidance + `references/`). Portable; runs anywhere, no Xcode connection needed.
